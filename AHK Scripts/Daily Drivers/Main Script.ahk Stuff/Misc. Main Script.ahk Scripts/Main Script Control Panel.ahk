...
;Ctrl + Insert.
GUI, CPanel:Font, s13
GUI, CPanel:Add, Text, x5 y70,Ctrl + Insert Hotkey Monitor Choice
GUI, CPanel:Font, s11
GUI, CPanel:Add, DropDownList, x5 y95 w136 vCtrlInsMonChoice, 1 (Primary Mon)|2 (Secondary Mon)||





GUI, CPanel:Show, w340 h400 x1200,Main Script Control Panel
